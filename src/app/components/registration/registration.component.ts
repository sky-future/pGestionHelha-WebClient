...
// import {UserRegisterRepository} from '../../commons/components/repositories/user-register-repository';
//
//
// @Component({
...
//
//   form: FormGroup;
//   constructor(private fb:FormBuilder,  private userApi: UserRegisterRepository) {
